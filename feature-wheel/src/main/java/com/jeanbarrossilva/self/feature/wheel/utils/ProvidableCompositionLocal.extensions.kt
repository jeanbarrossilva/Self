...
/** Material 3's [ProvidableCompositionLocal] for [ColorScheme]. **/
internal val LocalColorScheme
    @Composable get() = material3CompositionLocalOf(MaterialTheme.colorScheme)

/** Material 3's [ProvidableCompositionLocal] for [Shapes]. **/
